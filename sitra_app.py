                ...
                if estimation.get("error") or estimation.get("score") is None:
                    ...
                    if projection_min > 0 or projection_max > 0:
                        ...
                        <div style="background:linear-gradient(135deg,#1a1a2e,#16213e);border:1px solid #2a2a4e;border-radius:14px;padding:1.2rem 1.5rem;margin-bottom:8px">
                            <div style="font-size:0.95rem;font-weight:700;color:#a090f7;margin-bottom:0.8rem">Combien vous pourriez gagner en 1 an (pas par mois)</div>
                            <div style="font-size:28px;font-weight:700;color:#c0b8f0;margin-bottom:0.8rem">{projection_min_fmt} € — {projection_max_fmt} € <span style="font-size:15px;color:#a090f7">pour toute l'année</span></div>
